...
SECRET_KEY = 'django-insecure-_(ki3+=_ehzvz-irp82j2%p7izxf_d6$avcuut^(@tjhcan$ke'
...
STATIC_URL = 'static/'
STATICFILES_DIR = [BASE_DIR,'quizapp/static']
...
EMAIL_HOST_USER = 'ateebnaveed1996@gmail.com'
EMAIL_HOST_PASSWORD = 'eewwfdqwnaykvtue'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
